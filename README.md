...
<img src="https://img.shields.io/badge/AI%20Automation-8B5CF6?style=flat-square&logo=openai&logoColor=white" alt="AI Automation"/>
...
```mermaid
flowchart LR
    IN([Input]) --> LEAD[Lead capture]
    LEAD --> CRM[(CRM)]
    CRM --> LLM{{LLM: qualify + draft}}
    LLM --> CONTENT[Content]
